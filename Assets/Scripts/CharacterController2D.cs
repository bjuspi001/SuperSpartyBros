...
public class CharacterController2D : MonoBehaviour {
	...
	void Awake () {
		...
		//print("player's layer:" + _playerLayer);
		//print("platform's layer: " + _platformLayer);
	}
	...
	void Update()
	{
		...
		else if(canDoubleJump && Input.GetButtonDown("Jump")) // If canDoubleJump and jump button pressed, then allow the player to double jump
        {
			DoJump();
